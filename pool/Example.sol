...
contract TokenWrapper {
    ...
    IERC20 public stakeToken = IERC20(
        0x61dBfcbe5825a14CD4ed8E634A41B7d891B770F3
    );
...
contract Pool is TokenWrapper, IRewardDistributionRecipient {
    IERC20 public rewardToken = IERC20(
        0x86401D69F953CA26602bB01425B3968A736a7899
    );
    uint256 public constant DURATION = 2 hours;

    uint256 public constant startTime = 1607302800; //utc+8 2020-09-30 20:00:00
    ...
    {
        require(amount > 0, "Layerfi-POOL: Cannot stake 0");
        super.stake(amount);
    ...
    function withdraw(uint256 amount)
        ...
        updateReward(msg.sender)
    {
        require(amount > 0, "Layerfi-POOL: Cannot withdraw 0");
    ...
    modifier checkStart() {
        require(block.timestamp > startTime, "Layerfi-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "Layerfi-POOL: Pool is closed");
        _;
    }
